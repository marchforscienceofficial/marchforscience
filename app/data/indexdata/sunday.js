export default  {
  ...
  CTAs: [{
    ...
    body: 'Yesterday, over 600 cities marched worldwide. Many of these Satellites are signing on to become a permanent part of the March for Science network. To support these Satellites, we’re designing infrastrucutre and resources to connect communities to coordinated actions, needs, and resources. Keep an eye on your Satellite’s homepage; we’re rolling out exciting new features in the coming weeks.\n\nOnce you’ve signed up, recruit a few friends to do the same!',
    buttons: [
    ...
    body: 'This is just the beginning. We are building an organization centered on informed advocacy, community building, and accessible education. We’ll work with Satellites and partners to create new programs and scale existing programs aimed at improving the relationship between science and society.',
    buttons: [
